...
# #     # image = tf.keras.preprocessing.image.load_img(p+file,target_size=(224,224))
...
# #     predictions=1
# #     if predictions==1:
# #         class_label.append('Crack Detected')
# #     else:
# #         class_label.append('No Crack Detected')
    
# # df = pd.DataFrame()
# # df['filename'] = os.listdir(p)
# # df['class_label'] = class_label
# images=os.listdir('./static/images')
# results=os.listdir('./static/results')
# props=['length - 10 ; width - 10']*5#strings of this type